...
swift build -c release --product VesselCLI -Xswiftc -whole-module-optimization -Xlinker -dead_strip
cp .build/release/VesselCLI "$APP_BUNDLE/Contents/Resources/cctl"
